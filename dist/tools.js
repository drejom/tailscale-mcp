        ...
        try {
            ...
            switch (validatedArgs.operation) {
                case 'list': {
                    ...
                    const exitNodes = devices.filter((device) => device.advertisedRoutes?.includes('0.0.0.0/0') ||
                    ...
                    const exitNodeList = exitNodes.map((node) => {
        ...
        try {
            ...
            switch (validatedArgs.operation) {
                case 'list': {
                    ...
                    const webhookList = webhooks.map((webhook, index) => {
