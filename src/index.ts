      ...
      return {
        tools: [
            ...
            inputSchema: {
              ...
              properties: {
                ...
                aclConfig: {
                  type: "object",
                  description:
                    "ACL configuration (required for update/validate operations)",
                  properties: {
                    groups: {
                      type: "object",
            ...
            inputSchema: {
              ...
              properties: {
                ...
                nameservers: {
                  ...
                  items: { type: "string" },
                  description:
                    "DNS nameservers (for set_nameservers operation)",
                },
                magicDNS: {
                  type: "boolean",
                  description:
                    "Enable/disable MagicDNS (for set_preferences operation)",
                },
                searchPaths: {
                  type: "array",
                  items: { type: "string" },
                  description:
                    "DNS search paths (for set_searchpaths operation)",
                },
              },
              required: ["operation"],
            },
            ...
            inputSchema: {
              ...
              properties: {
                ...
                policy: {
                  type: "string",
                  description:
                    "Policy content (HuJSON format) for update operation",
                },
                testRequest: {
                  type: "object",
                  description:
                    "Access test parameters for test_access operation",
                  properties: {
                    src: { type: "string" },
                    dst: { type: "string" },
                    proto: { type: "string" },
            ...
            inputSchema: {
              ...
              properties: {
                ...
                sshSettings: {
                  type: "object",
                  description:
                    "SSH configuration settings for update operation",
                  properties: {
          ...
          },
          {
            ...
            description:
              "Get network and device statistics and monitoring data",
            inputSchema: {
              type: "object",
              properties: {
                operation: {
